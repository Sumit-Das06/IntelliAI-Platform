...
| **Last entry** | 2026-08-27 (Milestone 48: IntelliAI STT vs Sarvam saaras:v4 on the founder's real 102 s clip — WER delta ≤ ~4 pts (n=1, draft ref) but punctuation F1 0.000 vs 0.794: the gap is READABILITY, not recognition — English has no punctuation stage (M30 v1 is Hindi-scoped). Classification B; recommended next: M49 English punctuation/readability stage. Production untouched) |
