...
| **Last entry** | 2026-08-20 (Milestone 33: English TTS selection — Magpie-TTS 357M measured on CPU via NeMo-Speech.cpp GGUF, Chatterbox-nano measured, incumbent re-baselined on the M33 trap set) |
