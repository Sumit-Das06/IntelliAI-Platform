...
| **Last entry** | 2026-08-20 (Milestone 32: TTS model selection — Hindi paths measured, IndicF5 rejected on provenance, Supertonic 3 + KittenTTS + MMS-TTS-hin registered, espeak-ng subprocess path measured) |
...
| Kokoro-82M | speech_synthesis | EN shipped (WER 0.076 reproduced M32) · **HI measured via espeak spike: clean-slice CER 0.035, RTF 0.29** · AR none | Apache-2.0 (re-verified 2026-08-20) | **Approved for Adoption** — incumbent, in production (EN only); HI expansion recommended, founder-gated (M32) | 2026-08-20 |
| Supertonic 3 (Supertone) | speech_synthesis | 31 langs incl. EN+HI+**AR**; measured: EN WER 0.074 · HI clean CER 0.042 · RTF 0.44 · ~0.7 GiB ONNX | code MIT; **weights OpenRAIL-M (source, 2026-08-20)** — not permissive | Researching — quality/perf competitive; **adoption gated on founder license review** | 2026-08-20 |
...
| Qwen3-TTS | speech_synthesis | **open weights since 2026-01-22** (12Hz 0.6B/1.7B); 10 langs — **no Indic, no Arabic**; streaming 97 ms E2E (GPU claim) | Apache-2.0 (per-repo, 2026-08-20) | Researching — backup lineage on watch; wrong size class for CPU serve | 2026-08-20 |
