...
| **Last entry** | 2026-08-24 (Milestone 42: TTS PRODUCTION PROMOTION APPROVED (F-M42) — English + Hindi declared an approved production service in the repository catalog and production overlay; hindi-female=hf_alpha, hindi-male=hm_psi; rollback target test-pinned. Promoted, NOT deployed: Hostinger/DNS/customer traffic untouched) |
