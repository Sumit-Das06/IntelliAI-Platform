...
def main() -> int:
    ...
    record: dict[str, Any] = {
        "characterization": "24-e3-long-audio-concurrency",
        "NOT_A_GUARANTEE": (
            "capacity characterization of THIS machine's staging pair under a "
            "day of sustained bench load; client timeout 900s sits ABOVE the "
            "gateway's 450s budget so tail requests record the DEPLOYMENT's "
            "own verdict, never a client abort"
        ),
