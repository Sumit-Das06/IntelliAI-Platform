...
| **Last entry** | 2026-08-20 (Milestone 35: Kokoro hardening SHIPPED locally — trap WER 0.1247→0.0659 through the production path, espeak exec-boundary live, ONNX evaluated and declined, Web Speech Studio E2E-verified) |
...
| Kokoro-82M | speech_synthesis | EN **hardened through the production path (M35): trap WER 0.0659, CER 0.0251, median wall 748 ms, ladder clean to c=8, Web E2E verified** · HI measured via espeak spike (clean CER 0.035) — now unblocked by the same exec boundary · AR none | Apache-2.0 (re-verified 2026-08-20) | **Approved for Adoption** — incumbent; M35 hardening LOCAL/staging-verified (ONNX evaluated, declined); production launch + HI expansion founder-gated | 2026-08-20 |
