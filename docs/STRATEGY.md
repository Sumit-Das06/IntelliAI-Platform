...
- **Every milestone close:** risk-register sweep (AI_RESEARCH_REPORT Part 7 triggers) · foundation-model watch triggers (FOUNDATION_MODELS §14) · portfolio glance (MODEL_IDENTITY §1b).
- **Capability opening:** re-run the relevant FOUNDATION_MODELS verdicts through its permanent framework at the current date.
